...
<section>
  <div>
    ...
    <input type='checkbox' disabled='disabled'><label>Playercards 4/4</label>
  </div> 
  <div class="<?php if($status <= 1): ?>unlocked <?php else: ?>locked" <?php endif; ?>>
    <a class="station__link" <?php if($status == 1): ?> href="index.php?page=ownerStation2" <?php endif; ?>>
      <p>Station two</p>
    </a>
    <input type='checkbox' disabled='disabled'><label>Item cards 0/26</label>
  </div> 
  <div class="<?php if($status <= 2): ?>unlocked <?php else: ?>locked" <?php endif; ?>>
